...
if("TRUE" STREQUAL "TRUE")
  set(custom_messages_SOURCE_PREFIX /home/alaaeldin/EXP1/src/custom_messages)
  set(custom_messages_DEVEL_PREFIX /home/alaaeldin/EXP1/devel)
  ...
  set(custom_messages_INSTALL_PREFIX /home/alaaeldin/EXP1/install)
...
if(NOT "/home/alaaeldin/EXP1/devel/include " STREQUAL " ")
  set(custom_messages_INCLUDE_DIRS "")
  set(_include_dirs "/home/alaaeldin/EXP1/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'custom_messages' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'custom_messages' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alaaeldin/EXP1/src/custom_messages/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT custom_messages_NUM_DUMMY_TARGETS)
      set(custom_messages_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::custom_messages::wrapped-linker-option${custom_messages_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR custom_messages_NUM_DUMMY_TARGETS "${custom_messages_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::custom_messages::wrapped-linker-option${custom_messages_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND custom_messages_LIBRARIES "${interface_target_name}")
...
set(custom_messages_EXPORTED_TARGETS "custom_messages_generate_messages_cpp;custom_messages_generate_messages_eus;custom_messages_generate_messages_lisp;custom_messages_generate_messages_nodejs;custom_messages_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${custom_messages_dep}_FOUND)
      find_package(${custom_messages_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${custom_messages_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
